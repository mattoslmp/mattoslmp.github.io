...
- **Research grant (awards) as Investigador Principal of $158,588 USD on the Google/FCT! This grant, awarded in the "2ª edição Concurso de Projetos de Computação Avançada: Inteligência Artificial em Cloud," Project "unraveling Fatty Acyl-AMP Ligase substrates in Cyanobacteria using artificial intelligence". 2023, website: https://faalpred.ciimar.up.pt/**
